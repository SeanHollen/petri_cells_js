...
function randomProgram(size = 64, minInt = 0, maxInt = 10) {
    return Array.from({ length: size }, () => Math.floor(Math.random() * (maxInt - minInt + 1)) + minInt);
}
...
export { crossReactPrograms, randomProgram, toHumanReadableStr, fromHumanReadableStr }